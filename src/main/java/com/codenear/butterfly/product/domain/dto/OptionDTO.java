...
public record OptionDTO(
    ...
    public OptionDTO(Option option, int salePrice) {
        this(option.getId(), option.getSubtitle(), option.getProductName(), option.getProductImage(),
                option.getOriginalPrice(), option.getSaleRate(), salePrice);
    }
}
