...
public class ResponseUtil {
    ...
    public static ResponseEntity<?> createSuccessResponse(HttpStatus status, String message, Object body) {
        return ResponseEntity
                .status(status)
                .body(new ResponseDTO(status.value(), message, body));
    }

    public static ResponseEntity<?> createErrorResponse(ErrorCode errorCode, Object body) {
        return ResponseEntity
