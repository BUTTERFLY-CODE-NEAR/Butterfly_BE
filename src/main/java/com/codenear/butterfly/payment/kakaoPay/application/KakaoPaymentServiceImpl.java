...
@Service
public class KakaoPaymentServiceImpl extends PaymentService implements KakaoPaymentService {
    ...
    public KakaoPaymentServiceImpl(SinglePaymentRepository singlePaymentRepository,
